...
const toggleMenuIcon = (selectedNavigationITEM, event) => {
    ...
    $(selectedNavigationITEM).children('ul').children('li').removeClass("toggle-sub-menu");
    $(selectedNavigationITEM).children('ul').children('li').children('span').removeClass("toggle-rotate-icon");
