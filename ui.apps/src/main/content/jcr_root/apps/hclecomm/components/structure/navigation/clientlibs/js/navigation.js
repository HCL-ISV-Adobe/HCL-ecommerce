...
const toggleMenuIcon = (selectedNavigationITEM, event) => {
  ...
  $(selectedNavigationITEM)
    .children(".cmp-navigation__icon-show")
    .toggleClass("toggle-rotate-icon");
  ...
  $(selectedNavigationITEM)
    .children("ul")
    .children("li")
    .removeClass("toggle-sub-menu");
  $(selectedNavigationITEM)
    .children("ul")
    .children("li")
    .children("span")
    .removeClass("toggle-rotate-icon");
};
...
function manageNav() {
  if ($(window).width() <= 1023) {
    $("li.cmp-navigation__item")
      .children("ul.cmp-navigation__group")
      .prev()
      .css("pointer-events", "none");
    $("li.cmp-navigation__item")
      .children("ul.cmp-navigation__group")
      .siblings("span.cmp-navigation__icon")
      .addClass("cmp-navigation__icon-show");
  }
}
...
function manageIcon() {
  if ($(window).width() > 1023) {
    $("li.cmp-navigation__item")
      ...
      .first()
      .css({ display: "inline-block", float: "right", "margin-left": "10px" })
  ...
  if ($(window).width() <= 1023) {
    ...
    [...parentObject].forEach((parent, i) => {
      if (parent.lastElementChild.classList.contains("cmp-navigation__group")) {
        ...
        if (
          !parent.lastElementChild.firstElementChild.classList.contains(
            "hide--desktop"
          )
        ) {
          parentLi.className =
            "cmp-navigation__item cmp-navigation__item--level-1 hide--desktop";
