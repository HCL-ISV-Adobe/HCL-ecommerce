...
public class CustomerChangePasswordServlet extends SlingAllMethodsServlet {
        ...
        try {
            ...
            if (StringUtils.isNotEmpty(payload)) {
                ...
                if (isValidPayload(jsonPayload)) {
                    JSONObject changePasswordRes = changePassword(jsonPayload);
    ...
    public JSONObject changePassword(JSONObject jsonPayload) throws JSONException {
        return customerService.changePassword(jsonPayload);
    }
